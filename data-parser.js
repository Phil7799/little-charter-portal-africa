        ...
        this.hrData.forEach((row, i) => {
            ...
            if (!this.processedData.hr.byMonth[month]) {
                this.processedData.hr.byMonth[month] = {
                    ...
                    actual2025: 0, corporateClosures: 0, newRevenue: 0, oldRevenue: 0, totalRevenue2026: 0
                };
            }
            ...
            const rowData = { target2026, actual2026, actual2025, corporateClosures, newRevenue, oldRevenue, totalRevenue2026 };
        ...
        if (business === 'All' && month === 'All') {
            ...
            if (bd) {
                ...
                Object.keys(bd.months).forEach(m => {
                    if (!hrData.byMonth[m]) hrData.byMonth[m] = { businesses: {}, target2026: 0, actual2026: 0 };
            ...
            if (md) {
                ...
                Object.keys(md.businesses).forEach(b => {
                    hrData.byBusiness[b] = { months: { [month]: md.businesses[b] }, target2026: md.businesses[b].target2026, actual2026: md.businesses[b].actual2026 };
                });
            }
        } else {
            const bd = this.processedData.hr.byBusiness[business];
